...
/// `~/.local/bin/meetingcopilot`, kept pointing at the executable inside the bundle.
///
/// Agents and scripts call meetingcopilot by name, and the command line has to be the
...
enum AgentCLI {
    static let path = FileManager.default.homeDirectoryForCurrentUser
        .appendingPathComponent(".local/bin/meetingcopilot")
