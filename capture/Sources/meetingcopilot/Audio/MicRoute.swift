...
///
/// The answer meetingcopilot used to give was "whichever one was the default when the
...
/// system default, and therefore meetingcopilot, does not.
///
...
/// no call app, no answer from Core Audio, a meeting held in an app meetingcopilot does
/// not know about.
enum MicRoute {
