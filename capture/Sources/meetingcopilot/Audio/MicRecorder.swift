...
final class MicRecorder: @unchecked Sendable {
    ...
    /// mid-meeting leaves meetingcopilot recording the old one for the rest of the call.
    ...
    /// what we capture. meetingcopilot taps the device itself, so dropping voice
