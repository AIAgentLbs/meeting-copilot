...
/// The system's per-process audio objects (macOS 14.4+), which are how meetingcopilot
...
enum AudioProcesses {
    ...
    ///
    /// A process doing duplex I/O lists its output device here too (meetingcopilot's
