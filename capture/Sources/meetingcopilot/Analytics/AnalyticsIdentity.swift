...
///
/// Both files sit in `~/.config/meeting-copilot`, which makes "forget everything you
/// know about me, locally" a single `rm ~/.config/meeting-copilot/analytics*.json`.
enum AnalyticsIdentity {
    static let path = FileManager.default.homeDirectoryForCurrentUser
        .appendingPathComponent(".config/meeting-copilot/analytics.json")
