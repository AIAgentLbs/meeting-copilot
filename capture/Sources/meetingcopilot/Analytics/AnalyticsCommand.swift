...
/// `meetingcopilot analytics` — what is being sent, and the switch.
///
...
struct AnalyticsCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        abstract: "Show or change what meetingcopilot reports about how it is used."
    )
    ...
    func run() throws {
        ...
        if on {
            ...
            print("To forget it here:  rm ~/.config/meeting-copilot/analytics*.json")
        }
    }
}
