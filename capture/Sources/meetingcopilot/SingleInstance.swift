...
enum SingleInstance {
    private static let ping = Notification.Name("com.aiagentlabs.meeting-copilot.activate")
    private static let pong = Notification.Name("com.aiagentlabs.meeting-copilot.activate-ack")
