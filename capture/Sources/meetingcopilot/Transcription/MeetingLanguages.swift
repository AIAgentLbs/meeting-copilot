...
enum MeetingLanguages {
    ...
    /// languages meetingcopilot is actually used in, and a menu you scroll to reach
    ...
    /// The same set as a sentence, for the places that report what meetingcopilot is
    /// about to do rather than do it — `meetingcopilot doctor`, and the line under the
    /// setup window's menu.
