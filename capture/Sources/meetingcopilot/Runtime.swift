...
/// How this copy of meetingcopilot is running: as `MeetingCopilot.app`, or as the bare binary
/// it used to be.
///
...
enum Runtime {
    ...
    static var appBundle: Bundle? {
        ...
        // `~/.local/bin/meetingcopilot` is a symlink into the bundle, and Foundation
        ...
        let bundleURL = executable
            ...
            .deletingLastPathComponent()  // MeetingCopilot.app
    ...
    /// sequence of them.
    static let handOffMarker = "MEETINGCOPILOT_OPENED_BY_MEETINGCOPILOT"
