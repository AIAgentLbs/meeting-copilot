...
/// `meetingcopilot sessions` — what has been recorded and what is still owed on it.
...
/// `meetingcopilot process <folder>` — finish one session, wherever it lives now.
///
    ...
    func run() throws {
        ...
        case .transcribe(let clearingFirst):
            ...
            do {
                ...
                // meetingcopilot that is doing the work.
                print("")
                print(busy)
                throw ExitCode(1)
            } catch {
