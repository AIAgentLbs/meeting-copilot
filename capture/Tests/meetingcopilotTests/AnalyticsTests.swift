...
struct AnalyticsQueueTests {
    ...
    func theBodyIsWellFormed() throws {
        ...
        #expect(payload["hostname"] as? String == "app.meetingcopilot.me")
...
struct AnalyticsCatalogueSettingsTests {
    ...
    func freeTextNeverTravels() {
        let freeForm: [([String], Any)] = [
            ...
            (["transcription", "assemblyai", "api_key_path"], "~/.config/meeting-copilot/keys/assemblyai"),
            (["summary", "api_key_path"], "~/.config/meeting-copilot/keys/anthropic"),
...
struct AnalyticsCatalogueTests {
    ...
    @Test("Every event meetingcopilot can send is named in docs/analytics.md")
    ...
    @Test("Every property meetingcopilot can attach is named in docs/analytics.md")
    ...
    func thePromisesAreOnThePage() throws {
        let page = try Self.page
        #expect(page.contains("meetingcopilot analytics off"))
        #expect(page.contains("~/.config/meeting-copilot/analytics"))
