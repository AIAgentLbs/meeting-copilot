...
struct SpeakerAttributionTests {
    ...
    private final class Fixture {
        ...
        init() throws {
            dir = FileManager.default.temporaryDirectory
                .appendingPathComponent("meetingcopilot-attr-\(UUID().uuidString)", isDirectory: true)
    ...
    func noiseOnlyTrackLosesToSpeech() throws {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("meetingcopilot-noise-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
    ...
    func mixResamplesWithoutDrift() async throws {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("meetingcopilot-rates-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: dir) }
